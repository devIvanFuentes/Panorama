<div class="section pb-0">
    <div class="container">
        ...
        <div class="row">
            <div class="column col-<?php echo ( !empty( $fastwp_nord_images ) ? 6 : 12 ); ?>">
                ...
                if( !empty( $fastwp_nord_client ) || !empty( $fastwp_nord_date ) || !empty( $fastwp_nord_role ) || !empty( $fastwp_nord_aurl ) ) {
                	...
                	echo '<h6>' . esc_html__( 'Project Info', 'nord' ) . '</h6>
                ...
                <?php if( function_exists( 'fastwp_nord_share_links' ) ) fastwp_nord_share_links( '<div class="gap-50"></div>' ); ?>
            </div>
            ...
            foreach( $fastwp_nord_images as $fastwp_nord_image ) {
                ...
                $fastwp_nord_gallery_images[] = '<a href="' . esc_url( $fastwp_nord_image['image'] ) . '">
                                                    <img src="' . esc_url( $fastwp_nord_image['image'] ) . '" alt="' . esc_attr__( get_post_meta( $fastwp_nord_image['attachment_id'], '_wp_attachment_image_alt', true ) ) . '" />
                                                </a>';
            }
            ?>
            ...
            <div class="column col-6">
            	<div class="magnific-popup" data-gallery="true">
                    <?php echo implode( '<div class="gap-25"></div>', $fastwp_nord_gallery_images ); ?>
            	</div>
            </div>
            <?php } ?>
        </div>
